...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSE DEPSTORE            [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKKAN AKSES TOKEN: ${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "depan1" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Token Salah! Beli Kode Token Di depstore${NC}"
    echo -e "${YELLOW}TELEGRAM : @depannnb1${NC}"
    echo -e "${YELLOW}CHANNEL : @depstore11${NC}"
    echo -e "${YELLOW}HARGA TOKEN : 10K FREE UPDATE JIKA ADA TOKEN BARU${NC}"
    echo -e "${YELLOW}© DEPSTORE${NC}"
    exit 1
  fi
  clear
}
...
install_theme() {
  while true; do
    ...
    case "$SELECT_THEME" in
      1)
        THEME_URL=$(echo -e "https://github.com/depannn11/Autoinstaller-Pterodactyl/raw/main/stellar.zip")  
        break
        ;;
      2)
        THEME_URL=$(echo -e "https://github.com/depannn11/Autoinstaller-Pterodactyl/raw/main/billing.zip")
        break
        ;;
      3)
        THEME_URL=$(echo -e "https://github.com/depannn11/Autoinstaller-Pterodactyl/raw/main/enigma.zip")
        break
        ;; 
      x)
        return
...
# Unduh file tema
wget -O /root/stellar.zip https://github.com/depannn11/Autoinstaller-Pterodactyl/raw/main/stellar.zip
...
install_nebula_theme() {
    ...
    local REPO_URL="https://github.com/depannn11/Autoinstaller-Pterodactyl.git"
    local TEMP_DIR="Autoinstaller-Pterodactyl"
...
install_elysium_theme() {
    ...
    REPO_URL="https://github.com/depannn11/Autoinstaller-Pterodactyl.git"
    TEMP_DIR="Autoinstaller-Pterodactyl"
...
installTheme_nightcore(){
    ...
    git clone https://github.com/depannn11/Autoinstaller-Pterodactyl.git > /dev/null 2>&1
    cd Autoinstaller-Pterodactyl > /dev/null 2>&1
...
echo -e "${CYAN}┌──────────────────────────────────────────┐${NC}"
echo -e "${CYAN}│${WHITE} Author  : Depann                         ${CYAN}│${NC}"
echo -e "${CYAN}│${WHITE} Telegram: @depannnb1                     ${CYAN}│${NC}"
echo -e "${CYAN}│${WHITE} Channel : @depstore11                    ${CYAN}│${NC}"
echo -e "${CYAN}└──────────────────────────────────────────┘${NC}"

echo
echo -e "${YELLOW}┌─────────────── MENU UTAMA ───────────────┐${NC}"
echo -e "${YELLOW}│${GREEN} [1]${WHITE} Install Theme                        ${YELLOW}│${NC}"
echo -e "${YELLOW}│${GREEN} [2]${WHITE} Uninstall Theme                      ${YELLOW}│${NC}"
echo -e "${YELLOW}│${GREEN} [3]${WHITE} Configure Wings                      ${YELLOW}│${NC}"
echo -e "${YELLOW}│${GREEN} [4]${WHITE} Create Node                          ${YELLOW}│${NC}"
echo -e "${YELLOW}│${GREEN} [5]${WHITE} Uninstall Panel                      ${YELLOW}│${NC}"
echo -e "${YELLOW}│${GREEN} [6]${WHITE} Stellar Theme                        ${YELLOW}│${NC}"
echo -e "${YELLOW}│${GREEN} [7]${WHITE} Hack Back Panel                      ${YELLOW}│${NC}"
echo -e "${YELLOW}│${GREEN} [8]${WHITE} Ubah Password VPS                    ${YELLOW}│${NC}"
echo -e "${YELLOW}│${GREEN} [9]${WHITE} Install Depend                       ${YELLOW}│${NC}"
echo -e "${YELLOW}│${GREEN} [10]${WHITE} Tema Nebula (wajib depend)            ${YELLOW}│${NC}"
echo -e "${YELLOW}│${GREEN} [11]${WHITE} Tema Elysium                         ${YELLOW}│${NC}"
echo -e "${YELLOW}│${GREEN} [12]${WHITE} Tema Nightcore                       ${YELLOW}│${NC}"
echo -e "${YELLOW}│${RED} [X]${WHITE} Exit                                 ${YELLOW}│${NC}"
echo -e "${YELLOW}└──────────────────────────────────────────┘${NC}"

echo
read -rp "➤ Pilih menu: " MENU_CHOICE
clear
